...
class lint {
  ...
  exec { 'run_puppet-lint':
    command => 'sh puppet-lint /etc/puppetlabs/code/environments/production/manifests',
    path    => '/usr/local/share/gems/gems/puppet-lint-2.3.3',
    cwd     => '/usr/local/share/gems/gems/puppet-lint-2.3.3/bin',
    require => Package['rubygems'], 
  }
